...
/***/ function(module, exports, __webpack_require__) {
	...
	var superagent = __webpack_require__(159);
	...
	var Citation = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "div",
	            { className: "doiCitation" },
	            self.state.doiCitation ? React.createElement(
	                "div",
	                { className: "citation bg-info" },
	                " ",
	                self.state.doiCitation
	            ) : React.createElement(
	                "div",
	                { className: "message bg-danger" },
	                "Loading Citation..."
	            )
	        );
	    }
	...
	var DOISmall = React.createClass({
	    displayName: "DOISmall",

	    render: function render() {
	        var self = this;
	        var data = self.props.data;
	        var authors = data.authors.map(function (d) {
	            return React.createElement(
	                "div",
	                null,
	                d
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                null,
	                React.createElement(Citation, { doi: data.doi })
	            ),
	            React.createElement(
	                "div",
	                { className: "doiDescription" },
	                data.description
	            )
	        );
	    }
	    ...
	    render: function render() {
	        ...
	        if (this.state.error) {
	            return React.createElement(
	                "div",
	                null,
	                " Couldnt fetch data from the server"
	            );
	        }
	        var count = 0;
	        if (this.state.DOIs) {
	            ...
	            var DOI = DOIs.map(function (doi) {
	                count++;
	                return React.createElement(DOISmall, { data: doi, key: count });
	            });
	            return React.createElement(
	                "div",
	                null,
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { id: "header" },
	                React.createElement("img", { src: "images/tcia_logo_dark_sml.png" })
	            ),
	            React.createElement(
	                "div",
	                { className: "container" },
	                React.createElement(
	                    "div",
	                    { id: "sideBar", className: "col-md-3" },
	                    React.createElement(SideBar, null)
	                ),
	                React.createElement(
	                    "div",
	                    { id: "allDois", className: "col-md-9" },
	                    React.createElement(AllDOI, null)
	                )
	            )
	        );
	    }
